...
atom_info = {'H' : [0.32, '#ffffff', 1], 'He' : [0.46, '', 4], 'Li': 1.33, 'Be' : 1.02, 'B' : 0.85, 
...
'C' :"#909090", 'N' : "#3050f8", 'O' : "#ff0d0d", 'F'	: 0.64, 'Ne' : 0.67, 'Na' : 1.55, 
'Mg' : 1.39, 'Al' : 1.26, 'Si' : 1.16, 'P' : "#ffa500", 'S' : 1.03, 'Cl' : 0.99, 
'Ar' : 0.96 , 'K' : 1.96, 'Ca' : 1.71, 'Sc': 1.48, 'Ti' : 1.36, 'V' : 1.34, 
'Cr': 1.22,'Mn' : 1.19, 'Fe' : 1.16, 'Co' : 1.11, 'Ni' : 1.10,'Cu' : 1.12,
'Zn' : 1.18, 'Ga' : 1.24, 'Ge' : 1.21, 'As' : 1.21,	'Se' : 116,	'Br' : 1.14, 
'Kr' : 1.17, 'Rb' : 2.10, 'Sr' : 1.85, 'Y' :  1.63, 'Zr' : 1.54,'Nb' : 1.47,
...
def create_molecule(file_path, atom_radius = 0.8, bond_radius = 0.1):
    ...
    for atom in atoms:
        #print(atom)
        bpy.ops.mesh.primitive_ico_sphere_add(subdivisions=6, radius=atom_radius * radii[atom[0]], calc_uvs=True, 
        ...
        bpy.data.collections['Atoms'].objects.link(obj)
...
def clear_collection():
    ...
    try:
        bpy.data.collections.remove(bpy.data.collections.get('Atoms'))
        bpy.data.collections.remove(bpy.data.collections.get('Bonds'))
    except:
        pass
